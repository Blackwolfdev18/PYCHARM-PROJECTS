...
def draw_object(texture_based1, texture_based2, texture_based11, texture_based22 ):
...
def main():
    ...
    pygame.display.set_caption("Python Last Activity")
    ...
    # Load textures
    texture_surface1 = pygame.image.load('gojo.jpg')
    texture_data1 = pygame.image.tostring(texture_surface1, 'RGBA', 1)
    width1, height1 = texture_surface1.get_size()

    texture_surface11 = pygame.image.load('gojo.jpg')
    texture_data1 = pygame.image.tostring(texture_surface11, 'RGBA', 1)
    width1, height1 = texture_surface11.get_size()

    texture_surface2 = pygame.image.load('prisonRealm.jpeg')
    texture_data2 = pygame.image.tostring(texture_surface2, 'RGBA', 1)
    width2, height2 = texture_surface2.get_size()

    texture_surface22 = pygame.image.load('prisonRealm.jpeg')
    texture_data2 = pygame.image.tostring(texture_surface22, 'RGBA', 1)
    width2, height2 = texture_surface22.get_size()

    texture_id1 = add_texture_based(texture_data1, width1, height1)
    texture_id11 = add_texture_based(texture_data1, width1, height1)
    texture_id2 = add_texture_based(texture_data2, width2, height2)
    texture_id22 = add_texture_based(texture_data2, width2, height2)
    ...
    while True:
        ...
        if elapsed_time <= 2000:
            draw_object(texture_id1, texture_id2)
