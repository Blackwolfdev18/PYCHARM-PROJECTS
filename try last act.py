...
def main():
    ...
    pygame.display.set_caption("Last Python Project OpenGl(06 Performance Task 1) Comp Graphics")
    ...
    texture_surface11 = pygame.image.load('cube3.jpg')
    texture_data3 = pygame.image.tostring(texture_surface11, 'RGBA', 1)
    width3, height3 = texture_surface11.get_size()

    texture_surface22 = pygame.image.load('cube4.jpg')
    texture_data4 = pygame.image.tostring(texture_surface22, 'RGBA', 1)
    width4, height4 = texture_surface22.get_size()

    texture_id1 = add_texture_based(texture_data1, width1, height1)

    texture_id11 = add_texture_based(texture_data3, width3, height3)

    texture_id2 = add_texture_based(texture_data2, width2, height2)

    texture_id22 = add_texture_based(texture_data4, width4, height4)
    ...
    while True:
        ...
        if elapsed_time <= 2000:
            ...
            draw_object(texture_id11, texture_id11)
        elif elapsed_time <= 8000:
            draw_object(texture_id22, texture_id22)
